...
namespace PosTechFiapImagensWebApi.Services;
...
public class AzureStorageBlobService : IAzureStorageBlobService
{
    ...
    public AzureStorageBlobService(IConteinerAzureConfigProvider conteinerAzureConfigProvider)
    {
        _conteinerAzureConfigProvider = conteinerAzureConfigProvider;
    }

    public async Task<ImagemResponseViewModel> UploadImagemAsync(BinaryData binaryData, string nome)
    {
        ...
        return new ImagemResponseViewModel
        {
            Nome = nome,
